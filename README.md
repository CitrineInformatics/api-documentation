# Citrination OpenAPI Specification
...
6. If you did everything correct, https://citrineinformatics.github.io/api-documentation/ will lead to your new docs
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://citrineinformatics.github.io/api-documentation/ with url from the message: `Server started <url>`
